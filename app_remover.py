...
if HAS_MODERN_UI:
    class ModernAppRemover(ctk.CTk, TkinterDnD.DnDWrapper):
        ...
        def _init_pages(self):
            ...
            # App List Controls
            self.ctrl_uninstall = ctk.CTkFrame(self.frame_uninstall, fg_color="transparent")
            self.ctrl_uninstall.pack(fill="x", padx=20, pady=(0, 5))
            
            ctk.CTkButton(self.ctrl_uninstall, text="Select All", width=100, font=ctk.CTkFont(size=12), command=lambda: self._select_all(self.tree_apps)).pack(side="left", padx=(0, 10))
            ctk.CTkButton(self.ctrl_uninstall, text="Deselect All", width=100, font=ctk.CTkFont(size=12), fg_color="gray", hover_color="#555555", command=lambda: self._deselect_all(self.tree_apps)).pack(side="left")
            ...
            # Orphans Page Controls
            self.ctrl_orphans = ctk.CTkFrame(self.frame_orphans, fg_color="transparent")
            self.ctrl_orphans.pack(fill="x", padx=20, pady=(10, 5))
            
            ctk.CTkButton(self.ctrl_orphans, text="Select All", width=100, font=ctk.CTkFont(size=12), command=lambda: self._select_all(self.tree_orphans)).pack(side="left", padx=(0, 10))
            ctk.CTkButton(self.ctrl_orphans, text="Deselect All", width=100, font=ctk.CTkFont(size=12), fg_color="gray", hover_color="#555555", command=lambda: self._deselect_all(self.tree_orphans)).pack(side="left")
            ...
            self.ctrl_startup = ctk.CTkFrame(self.frame_startup, fg_color="transparent")
            self.ctrl_startup.pack(fill="x", padx=20, pady=(10, 5))
            
            ctk.CTkButton(self.ctrl_startup, text="Select All", width=100, font=ctk.CTkFont(size=12), command=lambda: self._select_all(self.tree_startup)).pack(side="left", padx=(0, 10))
            ctk.CTkButton(self.ctrl_startup, text="Deselect All", width=100, font=ctk.CTkFont(size=12), fg_color="gray", hover_color="#555555", command=lambda: self._deselect_all(self.tree_startup)).pack(side="left")
